...
const Header = (props: HeaderProps) => {
  ...
  return (
    <header className='w-full h-[100px] flex justify-between md:items-start items-center md:px-12 px-8 py-6'>
      <img className='w-[240px]' src={titleImg} alt='title' />
      <div className='flex space-x-4'>
        <span className='hidden md:inline font-bold'>{`${authState?.nickname} 的待辦`}</span>
